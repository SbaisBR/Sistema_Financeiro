...
begin
  ...
  cdsConsulta.Close;
  sqlConsulta.CommandText := 'SELECT C.*,E.CIDADE,  E.ESTADO, E.ENDERECO, E.NUMERO, E.BAIRRO, E.CEP FROM CADPRESTADOR C LEFT JOIN CADPRESTADOR_ENDERECO E ON (E.ID_PRESTADOR = C.ID AND E.TIPO_END = ''(Padrão)'')';
  cdsConsulta.Open;
  //Pesquisa por Codigo
  case cb_chave.ItemIndex of
  0: begin
